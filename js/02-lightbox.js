...
function onGallery(event) {
    ...
    const lightbox = new SimpleLightbox('.gallery a', { overlayOpacity: 1, animationSpeed: 200, fadeSpeed: 200, captionsData: "alt", captionDelay: 250, captionPosition:"bottom" });
};